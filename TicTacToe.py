...
class Player(metaclass=ABCMeta):
    ...
    @property
    def counter(self):
        """ Represent Players Counter - may be X or Y """
    ...
    def __str__(self):
        return self.__class__.__name__ + '[' + str(self._counter) + ']'
...
class ComputerPlayer(Player):
    ...
    def randomly_select_cell(self):
        """ User a simplistic random selection approach
    ...
    def get_move(self):
        """ Provide a very simple algorithm for
        selecting a move """
...
class Game:
    ...
    def select_player_to_go_first(self):
        """ Randomly select who will play first -
